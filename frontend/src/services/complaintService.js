...
export const answerReviewQuestion = async (
  token,
  questionId,
  answer
) => {
...
export const verifyRepair = async (
  token,
  action,
  comment = ""
) => {
...
export const acceptSiteInspection = async (token) => {
  const response = await api.post(
...
export const getComplaintsForAdmin = async (
  filters = {}
) => {
...
export const getComplaintByIdForAdmin = async (
  id
) => {
  const response = await api.get(
    `/complaints/admin/${id}`
...
export const askReviewQuestion = async (
  id,
  question
) => {
  const response = await api.post(
...
export const updateManagerConflict = async (
  id,
  concernsManager
) => {
...
export const assignAuthorizedAlternative = async (
  id,
  name,
  authority,
  contact
...
export const setComplaintNote = async (
  id,
  note
) => {
  const response = await api.put(
...
export const reviewReopenRequest = async (
  ...
  const response = await api.put(
    `/complaints/admin/${id}/reopen-review`,
    {
      decision,
      note,
    }
 ...
 *
 * Some components may import:
 * submitReopenReviewDecision
 *
 * Keep both names available.
 */

export const submitReopenReviewDecision =
  reviewReopenRequest;
...
export const requestSiteInspection = async (
  id,
  note = ""
) => {
  const response = await api.put(
...
export const getComplaintsForManager = async (
  filters = {}
) => {
  const params = new URLSearchParams(
    filters
